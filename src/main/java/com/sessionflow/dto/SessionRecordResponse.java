...
public class SessionRecordResponse {
    ...
    @Schema(description = "開始時間", example = "2024-01-15T14:00:00")
    private LocalDateTime startAt;
    
    @Schema(description = "結束時間", example = "2024-01-15T16:00:00")
    private LocalDateTime endAt;
    
    @Schema(description = "計畫備註（來自 Session）", example = "專注於核心功能開發")
