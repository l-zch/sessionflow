...
import com.sessionflow.service.application.impl.SessionRecordServiceImpl;
...
class SessionRecordServiceImplTest {
    ...
    void getSessionRecords_OnlyStartDate_Success() {
        ...
        when(sessionRecordRepository.findByStartAtBetween(any(LocalDateTime.class), any(LocalDateTime.class))).thenReturn(records);
        when(sessionRecordMapper.toResponseList(records)).thenReturn(expectedResponses);
    ...
    void getSessionRecords_WithDateRangeAndTaskId_Success() {
        ...
        when(sessionRecordRepository.findByStartAtBetweenAndTaskId(startDateTime, endDateTime, taskId)).thenReturn(records);
        when(sessionRecordMapper.toResponseList(records)).thenReturn(expectedResponses);
